Feature: Student Admissions
    ...
    Scenario Outline: Student Admissions
        ...
        Examples:
            ...
            | 123456      | 2468       | SDET         | Testing Fundamentals | Lauren    | Flores   | Female | 10/12/1995  | Testing sample | laurenflores23@hotmail.com | 08/13/2022    | A+         | 08/13/2022 | 703-875-9686 | 5'3    | 160    | Leon       | 571-911-5874 | Chef             | Rosalia    | 703-968-5412 | Chef             | Rosalia      | Mother           | TestingEmail  | 703-985-8547  | Chef               | Testing Address Dr |
